...
# heroText: Jamin's blog
heroText: Never say it's too late
tagline: 全栈开发技术博客，积跬步以至千里，积小流以成江海，致每个爱学习的你。
# tagline: Never never nver ever ever ever say it's too late。
# actionText: 立刻进入 →
# actionLink: /web/
...
features: # 可选的
  ...
  - title: 后端
    details: Python，Django，数据库等相关技术
    link: /server/
